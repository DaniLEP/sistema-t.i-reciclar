...
import { Save, ArrowLeft, CameraIcon, CheckCircle, AlertCircle, Loader2, Upload, ImageIcon } from "lucide-react"
        ...
        >
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-8 text-white">
            ...
            >
              ...
              <div>
                <h1 className="text-3xl font-bold">Cadastro de Câmera</h1>
                <p className="text-indigo-100 mt-1">Registre novos equipamentos fotográficos</p>
              </div>
            </motion.div>
          </div>
