...
import { TabletSmartphone, Save, ArrowLeft } from "lucide-react";
import { useNavigate } from "react-router-dom";
import { Input } from "@/components/ui/input/input";

export default function CadastroTablet() {
  const [form, setForm] = useState({patrimonio: "", 
    marca: "", modelo: "", local: "", notaFiscal: "",  obs: "", projeto: "", fotoBase64: "",  status: "Disponível", dataCadastro: "", NCM: "", 
    vrbem: "", projetoEditalConvenio: "", parceiro: "",ano: "" });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setForm({patrimonio: "", marca: "", modelo: "", local: "",  notaFiscal: "",  obs: "",
        projeto: "",  fotoBase64: "",  status: "Disponível", dataCadastro: "", NCM: "", vrbem: "", parceiro: "", projetoEditalConvenio: "", ano: "" });} 
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-purple-600 via-indigo-700 to-gray-900 p-6">
      <motion.div className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl p-10"
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-800">Cadastro de Tablet</h2>
        </div>
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {/* FOTO */}
            <div>
              <label className="block text-gray-700 font-medium mb-1">Foto do Tablet</label>
            ...
            <motion.button whileTap={{ scale: 0.97 }} type="submit"
              ...
              <Save className="w-5 h-5" /> Cadastrar Tablet
            </motion.button>
